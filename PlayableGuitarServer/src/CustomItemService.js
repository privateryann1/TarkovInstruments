    ...
    postDBLoad() {
        ...
        for (const itemId in this.configs) {
            ...
            if (this.Instance.debug) {
                ...
                console.log(`Prefab Path: ${(_a = exampleCloneItem.overrideProperties) === null || _a === void 0 ? void 0 : _a.Prefab.path}`);
            }
    ...
    createExampleCloneItem(itemConfig, itemId) {
        ...
        const exampleCloneItem = {
            ...
            overrideProperties: itemConfig.overrideProperties
                ? Object.assign(Object.assign({}, itemConfig.overrideProperties), { Prefab: {
                        path: ((_a = itemConfig.overrideProperties.Prefab) === null || _a === void 0 ? void 0 : _a.path) || itemPrefabPath,
                        rcid: ""
                    } }) : undefined,
